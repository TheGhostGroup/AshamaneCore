...
void Creature::RemoveCorpse(bool setSpawnTime, bool destroyForNearbyPlayer)
{
...
void Creature::Regenerate(Powers power)
{
    ...
    if (!HasFlag(UNIT_FIELD_FLAGS, UNIT_FLAG2_REGENERATE_POWER))
        return;
